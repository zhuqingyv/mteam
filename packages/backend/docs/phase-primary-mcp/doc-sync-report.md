...
### 3. `packages/backend/docs/architecture-overview.md`
...
### 5. `packages/backend/docs/mteam-tools.md`
...
### 6. `packages/backend/docs/phase-primary-mcp/design.md`
...
grep -rn '主.*Agent.*mteam[^-]' docs/frontend-api/ packages/backend/docs/architecture-overview.md packages/renderer/docs/
