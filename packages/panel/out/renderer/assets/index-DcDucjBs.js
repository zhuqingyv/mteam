...
function isPromiseLike$1(p2) {
  return typeof (p2 == null ? void 0 : p2.then) === "function";
}
  ...
  const setter = (a, ...args2) => {
    ...
    try {
      if (a === atom2) {
        ...
        const v2 = args2[0];
        setAtomStateValueOrPromise(store, a, v2);
        mountDependencies(store, a);
...
const createContinuablePromise = (store, promise, getValue) => {
  ...
  if (!continuablePromise) {
    continuablePromise = new Promise((resolve, reject) => {
      let curr = promise;
      const onFulfilled = (me2) => (v2) => {
        if (curr === me2) {
          resolve(v2);
        }
      };
      const onRejected = (me2) => (e) => {
        if (curr === me2) {
          reject(e);
        }
      };
...
const workingCountAtom = atom((get) => get(membersAtom).filter((m2) => m2.status === "working").length);
const onlineCountAtom = atom((get) => get(membersAtom).filter((m2) => m2.status === "online").length);
const offlineCountAtom = atom((get) => get(membersAtom).filter((m2) => m2.status === "offline").length);
const healthyAtom = atom((get) => get(teamStatusAtom)?.healthy ?? true);
const activeProjectsCountAtom = atom((get) => get(projectsAtom).filter((p2) => !["done", "abandoned"].includes(p2.status)).length);
function IpcBridge() {
  ...
  reactExports.useEffect(() => {
    ...
    window.teamHub.getTheme().then((t2) => {
      setTheme(t2);
    ...
    const unsubTheme = window.teamHub.onThemeChange((t2) => {
      setTheme(t2);
      document.documentElement.setAttribute("data-theme", t2);
    });
    return () => {
...
function Header() {
  ...
  React.useEffect(() => {
    const id2 = setInterval(forceUpdate, 1e3);
...
const avatar = "_avatar_1i2xb_1";
const initial = "_initial_1i2xb_13";
const dot = "_dot_1i2xb_17";
const dotWorking = "_dotWorking_1i2xb_27";
const dotOnline = "_dotOnline_1i2xb_31";
const dotOffline = "_dotOffline_1i2xb_35";
const dotReserved = "_dotReserved_1i2xb_39";
const pulse = "_pulse_1i2xb_1";
const styles$7 = {
  avatar,
  initial,
  dot,
...
function Avatar({ uid, displayName: displayName2, size = 28, status }) {
  const bg2 = uidToColor(uid);
  const fontSize = Math.round(size * 0.46);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: styles$7.avatar,
      style: { width: size, height: size, backgroundColor: bg2, fontSize },
      children: [
...
function groupByProject(members) {
  ...
  for (const m2 of members) {
    if (m2.status !== "working") continue;
    const proj = m2.project ?? "未知项目";
    if (!map.has(proj)) map.set(proj, []);
    map.get(proj).push(m2);
  }
  return map;
}
function MemberList({ onMemberClick }) {
  ...
  const [, forceUpdate] = React.useReducer((x2) => x2 + 1, 0);
  React.useEffect(() => {
    const id2 = setInterval(forceUpdate, 6e4);
    return () => clearInterval(id2);
  }, []);
  const reservedMembers = members.filter((m2) => m2.status === "reserved");
  const workingGroups = groupByProject(members);
  const onlineMembers = members.filter((m2) => m2.status === "online");
  const offlineMembers = members.filter((m2) => m2.status === "offline");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.list, children: [
    reservedMembers.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.projectGroup, children: [
      ...
      reservedMembers.map((member, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { uid: member.uid, displayName: member.displayName, size: 24, status: "reserved" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `${styles$6.memberName} ${member.type === "temporary" ? styles$6.tempName : ""}`, children: member.displayName }),
    ...
    workingGroups.size > 0 ? Array.from(workingGroups.entries()).map(([project, projectMembers]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.projectGroup, children: [
      ...
      projectMembers.map((member, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          onClick: () => onMemberClick(member.name),
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { uid: member.uid, displayName: member.displayName, size: 24, status: "working" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `${styles$6.memberName} ${member.type === "temporary" ? styles$6.tempName : ""}`, children: member.displayName }),
    ...
    onlineMembers.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.idleSection, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$6.idleLabel, children: "在线" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$6.idleGrid, children: onlineMembers.map((m2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: styles$6.idleCard,
          onClick: () => onMemberClick(m2.name),
          title: m2.name,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { uid: m2.uid, displayName: m2.displayName, size: 32, status: "online" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$6.idleName, children: m2.displayName }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$6.idleRole, children: m2.role })
          ]
        },
        m2.uid
      )) })
    ...
    offlineMembers.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.idleSection, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$6.idleGrid, children: offlineMembers.map((m2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: styles$6.idleCard,
          onClick: () => onMemberClick(m2.name),
          title: m2.name,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { uid: m2.uid, displayName: m2.displayName, size: 32, status: "offline" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$6.idleName, children: m2.displayName }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$6.idleRole, children: m2.role })
          ]
        },
...
const overlay = "_overlay_1608v_1";
const modal = "_modal_1608v_11";
const header = "_header_1608v_24";
const title = "_title_1608v_32";
const closeBtn = "_closeBtn_1608v_38";
const body = "_body_1608v_53";
const hint = "_hint_1608v_60";
const empty$3 = "_empty_1608v_65";
const cliList = "_cliList_1608v_72";
const cliRow = "_cliRow_1608v_78";
const cliSelected = "_cliSelected_1608v_95";
const cliIcon = "_cliIcon_1608v_100";
const cliInfo = "_cliInfo_1608v_107";
const cliName = "_cliName_1608v_115";
const cliBin = "_cliBin_1608v_121";
const cliVersion = "_cliVersion_1608v_130";
const cliCheck = "_cliCheck_1608v_136";
const toast = "_toast_1608v_143";
const errorMsg = "_errorMsg_1608v_154";
const footer$2 = "_footer_1608v_164";
const cancelBtn = "_cancelBtn_1608v_173";
const retryBtn = "_retryBtn_1608v_189";
const launchBtn = "_launchBtn_1608v_205";
const spinner = "_spinner_1608v_232";
const styles$5 = {
  overlay,
  modal,
  header,
...
function LeadModal({ memberName: memberName2, displayName: displayName2, onClose }) {
  ...
  const handleLaunch = async () => {
    ...
    setErrorMsg("");
    try {
      await window.api?.launchMember?.(memberName2, selected.bin);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$5.overlay, onClick: handleOverlayClick, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$5.modal, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$5.body, children: [
      clis.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$5.empty, children: "未检测到 agent CLI" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$5.footer, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          disabled: !selected || launchState === "loading" || launchState === "success",
          onClick: handleLaunch,
          children: launchState === "loading" ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$5.spinner }) : launchState === "success" ? "已启动" : "启动"
        }
      )
    ] })
  ] }) });
...
const nameLabel = "_nameLabel_ir4jt_101";
...
function MemberDetail({ memberName: memberName2, onBack }) {
  ...
  reactExports.useEffect(() => {
    window.teamHub.getMemberMcps(memberName2).then((mcps) => {
      setMountedNames(new Set(mcps.map((m2) => m2.name)));
    });
  }, [memberName2]);
  reactExports.useEffect(() => {
  ...
  const { profile, persona, memory, workLog, status, project, task, lastSeen } = detail;
  const statusLabel2 = { working: "工作中", online: "在线", offline: "离线" }[status];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$4.container, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$4.topBar, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$4.topName, children: profile.display_name })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$4.profileCard, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { uid: profile.uid, displayName: profile.display_name, size: 56, status }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$4.profileInfo, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$4.displayName, children: profile.display_name }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$4.subMeta, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$4.nameLabel, children: profile.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$4.uidLabel, children: profile.uid.slice(0, 8) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$4.tabs, children: ["persona", "memory", "log", "projects", "config"].map((t2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        className: `${styles$4.tab} ${tab2 === t2 ? styles$4.tabActive : ""}`,
        onClick: () => setTab(t2),
        children: [
          { persona: "角色", memory: "经验", log: "记录", projects: "项目", config: "配置" }[t2],
          t2 === "config" && mountedNames.size > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$4.configBadge, children: mountedNames.size }),
          t2 === "projects" && memberProjects.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$4.configBadge, children: memberProjects.length })
        ]
      },
      t2
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$4.tabContent, children: [
      ...
      tab2 === "projects" && (memberProjects.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$4.empty, children: "暂未参与项目" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$4.projectList, children: memberProjects.map((p2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$4.projectRow, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$4.projectDot, style: { background: p2.status === "done" ? "#22c55e" : p2.status === "abandoned" ? "#6b7280" : "#3b82f6" } }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$4.projectRowName, children: p2.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$4.projectRowStatus, children: { planning: "策划", designing: "设计", developing: "开发", testing: "测试", bugfixing: "Bug修复", done: "完毕", abandoned: "废弃" }[p2.status] }),
...
function buildCommand(pkg) {
  ...
  const id2 = pkg.identifier;
  if (hint2 === "npx") return { command: "npx", args: ["-y", id2] };
  if (hint2 === "uvx") return { command: "uvx", args: [id2] };
  if (hint2 === "node") return { command: "node", args: [id2] };
  if (hint2 === "docker") return { command: "docker", args: ["run", "-i", id2] };
  if (pkg.registryType === "npm") return { command: "npx", args: ["-y", id2] };
  if (pkg.registryType === "pypi") return { command: "uvx", args: [id2] };
  return { command: id2, args: [] };
}
function McpStore() {
  ...
  const doSearch = reactExports.useCallback((q2) => {
    setSearch(q2);
    window.teamHub.getRegistry(q2 || void 0).then(setRegistry);
  ...
  function getMountedMembers(mcpName2) {
    return memberMounts.filter((m2) => m2.mcps.includes(mcpName2)).map((m2) => m2.displayName);
  }
...
function ProjectList() {
  ...
  const getMemberInfo = (name) => members.find((m2) => m2.name === name);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.container, children: [
    ...
    projects.length === 0 && !creating ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.empty, children: [
    ...
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.list, children: projects.map((p2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.card, onClick: () => setSelected(p2.id), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.cardTop, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.projectName, children: p2.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.statusTag, style: { background: STATUS_COLORS$1[p2.status] + "18", color: STATUS_COLORS$1[p2.status] }, children: STATUS_LABELS[p2.status] })
      ] }),
      p2.description && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.desc, children: p2.description }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.progressBar, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.progressFill, style: { width: `${p2.progress}%`, background: STATUS_COLORS$1[p2.status] } }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.cardBottom, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.memberAvatars, children: [
          p2.members.slice(0, 5).map((name) => {
            const m2 = getMemberInfo(name);
            return /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { uid: m2?.uid ?? name, displayName: m2?.displayName ?? name, size: 18 }, name);
          }),
          p2.members.length > 5 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: styles$2.moreMembers, children: [
            "+",
            p2.members.length - 5
          ] }),
          p2.members.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.noMembers, children: "无成员" })
        ] }),
...
function ProjectDetail({ projectId, onBack }) {
  ...
  const load = reactExports.useCallback(() => {
    window.teamHub.getProject(projectId).then((p2) => {
      setProject(p2);
      setLoading(false);
    });
  }, [projectId]);
  ...
  const commitEdit = (field) => {
    if (field === "description" || field === "experience") {
      ...
      const n2 = Math.min(100, Math.max(0, parseInt(editValue) || 0));
      save({ progress: n2 });
    }
    setEditing(null);
  };
  const toggleMember = reactExports.useCallback((memberName2) => {
    ...
    const members = has ? project.members.filter((m2) => m2 !== memberName2) : [...project.members, memberName2];
    save({ members });
  }, [project, save]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.container, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$1.tabs, children: ["overview", "members", "rules"].map((t2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        className: `${styles$1.tab} ${tab2 === t2 ? styles$1.tabActive : ""}`,
        onClick: () => setTab(t2),
        children: { overview: "概览", members: `成员(${project.members.length})`, rules: "规则" }[t2]
      },
      t2
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.tabContent, children: [
      ...
      tab2 === "members" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.memberContent, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$1.memberGrid, children: allMembers.map((m2) => {
          const inProject = project.members.includes(m2.name);
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `${styles$1.memberCard} ${inProject ? styles$1.memberIn : ""}`,
              onClick: () => toggleMember(m2.name),
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { uid: m2.uid, displayName: m2.displayName, size: 28, status: m2.status }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$1.memberName, children: m2.displayName }),
      ...
      tab2 === "rules" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.rulesContent, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          RuleList,
          {
            ...
            onAdd: (v2) => addListItem("forbidden", v2),
...
const nav = "_nav_1gree_1";
const tabs$1 = "_tabs_1gree_10";
const tab = "_tab_1gree_10";
const active = "_active_1gree_34";
const badge = "_badge_1gree_40";
const stats = "_stats_1gree_50";
const styles = {
  nav,
  tabs: tabs$1,
  tab,
